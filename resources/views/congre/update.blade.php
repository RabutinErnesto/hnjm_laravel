        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{route('congre.update', $congre->id)}}" method="POST">
                @csrf
                @method('PATCH')
                <div class="col-12">
                  <label  class="form-label">Titre</label>
                  <input type="text" name="titre" value="{{ $congre->titre }}" class="form-control" id="congre"  required>
                  <div class="invalid-feedback">Tapez le congre!</div>
                </div>
                <div class="col-12">
                    <label for="auteur" class="form-label">Auteur</label>
                  <select name="auteur" id="auteur" class="form-control form-select">
                      <option value="{{ $congre->auteur_id }}">{{ $congre->auteur }}</option>
                ...
                <div class="col-12">
                    ...
                    <input type="date" value="{{ $congre->date_congre }}" name="date" class="form-control" id="congre"  required>
                    <div class="invalid-feedback">Tapez le congre!</div>
                  </div>
                  <div class="col-12">
